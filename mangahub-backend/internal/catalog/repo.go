...
func (r *mongoRepo) Create(ctx context.Context, m *domain.Manga) (primitive.ObjectID, error) {
	now := time.Now().UTC()
	m.CreatedAt = now
	m.UpdatedAt = now
...
func (r *mongoRepo) Get(ctx context.Context, id primitive.ObjectID) (*domain.Manga, error) {
	var m domain.Manga
...
func (r *mongoRepo) Update(ctx context.Context, id primitive.ObjectID, set bson.M) (*domain.Manga, error) {
...
func (r *mongoRepo) List(ctx context.Context, q domain.MangaListQuery) ([]*domain.Manga, int64, error) {
	filter := bson.M{}
	if q.Genre != "" {
	...
	out := make([]*domain.Manga, 0, q.Limit)
...
func (r *mongoRepo) ListByArtist(ctx context.Context, artistID primitive.ObjectID, page, limit int) ([]*domain.Manga, int64, error) {
...
func (r *mongoRepo) Popular(ctx context.Context, limit int) ([]*domain.Manga, error) {
...
func (r *mongoRepo) Trending(ctx context.Context, limit int) ([]*domain.Manga, error) {
