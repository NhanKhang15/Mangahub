...
func (r *mongoRepo) Upsert(ctx context.Context, p *domain.ReadingProgress) (*domain.ReadingProgress, error) {
...
func (r *mongoRepo) Get(ctx context.Context, userID, mangaID primitive.ObjectID) (*domain.ReadingProgress, error) {
...
func (r *mongoRepo) List(ctx context.Context, userID primitive.ObjectID, status string, page, limit int) ([]*domain.ReadingProgress, int64, error) {
